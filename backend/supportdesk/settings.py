...
SUPPORT_EMAIL_ENABLED = os.getenv('SUPPORT_EMAIL_ENABLED', 'False').lower() == 'true'
...
EMAIL_TIMEOUT = 20
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', EMAIL_HOST_USER or 'SupportDesk <no-reply@example.com>')
