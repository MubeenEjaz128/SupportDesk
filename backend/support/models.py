...
class AgentProfile(models.Model):
    ROLE_CHOICES = [('admin','Admin'),('supervisor','Supervisor'),('agent','Agent')]
...
class Ticket(models.Model):
    ...
    SOURCE = [('email','Email'),('web','Web'),('phone','Phone'),('chat','Chat'),('social','Social')]
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    ...
    def __str__(self): return f'{self.ticket_number} - {self.subject}'

class TicketMessage(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    ticket = models.ForeignKey(Ticket, on_delete=models.CASCADE, related_name='messages')
    author = models.ForeignKey(User, null=True, blank=True, on_delete=models.SET_NULL, related_name='ticket_messages')
